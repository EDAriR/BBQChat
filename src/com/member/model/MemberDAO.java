...
public class MemberDAO implements MemberDAO_interface {
    ...
    private static final String INSERT_STMT =
            "INSERT INTO member (mem_no, exp_no, memg_gr, mem_acct, mem_pwd, mem_joind, mem_updated, " +
                    "mem_name, mem_aka, mem_photo, mem_adds, mem_addc, mem_phone, mem_mail, " +
                    "mem_intro_b, mem_is_sell, mem_acct_s, mem_intro_s, " +
                    "mem_point_s, mem_intro_e, mem_is_stop, mem_point_b) " +
                    "VALUES ('M'||LPAD(to_char(mem_no_seq.NEXTVAL), 7, '0'), ?, '0', ?, ?, " +
                    "SYSDATE, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, '0', ?)";
    ...
    private static final String UPDATE =
            "UPDATE member SET exp_no=?, memg_gr=?, mem_acct=?, mem_pwd=?, " +
                    "mem_joind=?, mem_updated=?, mem_name=?, mem_aka=?, mem_photo=?, " +
                    "mem_adds=?, mem_addc=?, mem_phone=?, mem_mail=?, mem_intro_b=?, mem_is_sell=?, " +
                    "mem_acct_s=?, mem_intro_s=?, mem_point_s=?, mem_intro_e=?, mem_is_stop=?, mem_point_b=? " +
                    "WHERE mem_no = ?";
